...
import 'package:gehnamall/views/home/category_for_menu/product_card_menu/product_widgets_menu.dart';
import 'package:get/get.dart';

class ProductListMenuController extends GetxController {
...
class ProductListMenu extends StatelessWidget {
  ...
  final ProductListMenuController controller =
      Get.put(ProductListMenuController());
        ...
        : fetchHook.data == null || fetchHook.data!.isEmpty
            ...
            : GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ProductCardMenu(product: product);
                },
              );
  }
}
